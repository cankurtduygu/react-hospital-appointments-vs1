...
const AddPatient = ({
  ...
  const reasonOptions = [
    ...
    {
      value: 'FIRST_EXAM',
      label: 'First Examination - First time examination',
    },
  ...
  const handleSubmit = (e) => {
    ...
    const selectedReasonLabel =
      reasonOptions.find((opt) => opt.value === inputReason)?.label ||
      inputReason;
        ...
        <Col md={6}>
          ...
          <Button
            ...
            style={{
              ...
              fontSize: 18,
              marginBottom: '1.2rem',
              boxShadow: '0 2px 8px 0 rgba(131,56,236,0.10)',
              display: 'inline-flex',
              alignItems: 'center',
          ...
          >
            ...
            <span style={{ fontWeight: 600 }}>Back to Doctors</span>
          </Button>

          {/* Doctor Card */}
          <Card
            className="mb-4 doctor-add-card"
            style={{
              borderRadius: 24,
              boxShadow: '0 4px 32px 0 rgba(58,134,255,0.10)',
            ...
            >
              <img
                ...
                style={{
                  ...
                  objectFit: 'cover',
                  borderRadius: 18,
                  boxShadow: '0 2px 12px 0 rgba(58,134,255,0.10)',
                  border: '2.5px solid #3a86ff',
                  background: '#f6faff',
                  marginBottom: 18,
                  animation: 'popDoctor 1.2s',
                }}
              />
              <div
                style={{
          ...
          <Form onSubmit={handleSubmit} style={{ marginTop: '1.5rem' }}>
            ...
            <Button
              ...
              style={{
                ...
                fontSize: 18,
                marginBottom: '2.2rem',
                boxShadow: '0 2px 8px 0 rgba(58,134,255,0.10)',
                animation: 'popBtn 1.1s',
                display: 'block',
              }}
            >
